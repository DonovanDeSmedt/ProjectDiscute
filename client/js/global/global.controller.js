angular.module('discuteApp.global', []).controller('GlobalController', function($scope,$rootScope,$cookies,$http,$state,$location, $timeout, AuthenticationService){
	...
	$rootScope.splitArray = function(discutes){
		...
		let nextIndex = 3;
		let newArray = [];
		for(let i=0; i< discutes.length/3; i++){
